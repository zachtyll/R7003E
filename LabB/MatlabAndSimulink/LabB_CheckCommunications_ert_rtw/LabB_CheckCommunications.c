...
void LabB_CheckCommunications_initialize(void)
{
  ...
  /* External mode info */
  LabB_CheckCommunications_M->Sizes.checksums[0] = (541084999U);
  LabB_CheckCommunications_M->Sizes.checksums[1] = (3227791047U);
  LabB_CheckCommunications_M->Sizes.checksums[2] = (2177122257U);
  LabB_CheckCommunications_M->Sizes.checksums[3] = (2533341528U);
