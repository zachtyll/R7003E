...
## Generated on : Tue Dec 14 13:28:35 2021
...
START_DIR                 = E:/MATLAB-Projects/R7003E/LabB/MatlabAndSimulink
SOLVER                    = 
SOLVER_OBJ                = 
CLASSIC_INTERFACE         = 0
TGT_FCN_LIB               = None
...
INCLUDES_BUILDINFO = -I$(START_DIR) -I$(MATLAB_ROOT)/SupportPackages/3P.instrset/arduinoide.instrset/hardware/arduino/avr/libraries/Wire -I$(MATLAB_ROOT)/SupportPackages/3P.instrset/arduinoide.instrset/hardware/arduino/avr/libraries/Wire/utility -IE:/MATLAB-Projects/R7003E/LabB/RensselaerArduinoSupportPackageLibrary/RASPlib/include -I$(MATLAB_ROOT)/SupportPackages/3P.instrset/arduinoide.instrset/hardware/arduino/avr/libraries/Wire/src -I$(MATLAB_ROOT)/SupportPackages/3P.instrset/arduinoide.instrset/hardware/arduino/avr/libraries/Wire/src/utility -I$(START_DIR)/LabB_TuneTheGyro_ert_rtw -I$(MATLAB_ROOT)/extern/include -I$(MATLAB_ROOT)/simulink/include -I$(MATLAB_ROOT)/rtw/c/src -I$(MATLAB_ROOT)/rtw/c/src/ext_mode/common -I$(MATLAB_ROOT)/rtw/c/ert -I$(MATLAB_ROOT)/toolbox/coder/rtiostream/src -I$(MATLAB_ROOT)/toolbox/coder/rtiostream/src/utils -I$(ARDUINO_ROOT)/hardware/arduino/avr/cores/arduino -I$(ARDUINO_ROOT)/hardware/arduino/avr/variants/mega -I$(MATLAB_ROOT)/SupportPackages/toolbox/target/supportpackages/arduinotarget/include -I$(MATLAB_ROOT)/SupportPackages/toolbox/target/supportpackages/arduinotarget/scheduler/include -I$(MATLAB_ROOT)/SupportPackages/toolbox/target/supportpackages/arduinobase/include -I$(ARDUINO_ROOT)/hardware/tools/avr/avr/include/avr -I$(MATLAB_ROOT)/SupportPackages/toolbox/target/shared/externalmode_daemon/include
...
DEFINES_ = -D__MW_TARGET_USE_HARDWARE_RESOURCES_H__ -DMW_TIMERID=5 -DMW_PRESCALAR=256 -DMW_TIMERCOUNT=64911 -DMW_SCHEDULERCOUNTER=1 -D_RTT_BAUDRATE_SERIAL0_=115200 -D_RTT_BAUDRATE_SERIAL1_=9600 -D_RTT_BAUDRATE_SERIAL2_=9600 -D_RTT_BAUDRATE_SERIAL3_=9600 -D_RTT_ANALOG_REF_=0 -D_RTT_OVERRUN_DIGITAL_PIN_=13
...
SRCS = Wire.cpp twi.c I2Cdev.cpp MPU6050.cpp MPU6050wrapper.cpp $(START_DIR)/LabB_TuneTheGyro_ert_rtw/LabB_TuneTheGyro.c $(START_DIR)/LabB_TuneTheGyro_ert_rtw/LabB_TuneTheGyro_data.c $(MATLAB_ROOT)/rtw/c/src/ext_mode/common/updown.c $(MATLAB_ROOT)/rtw/c/src/ext_mode/common/ext_work.c $(MATLAB_ROOT)/toolbox/coder/rtiostream/src/utils/rtiostream_utils.c $(MATLAB_ROOT)/SupportPackages/toolbox/target/supportpackages/arduinotarget/registry/../src/MW_ArduinoHWInit.cpp $(MATLAB_ROOT)/SupportPackages/toolbox/target/supportpackages/arduinobase/src/io_wrappers.cpp $(MATLAB_ROOT)/SupportPackages/toolbox/target/supportpackages/arduinotarget/registry/../scheduler/src/arduinoAVRScheduler.cpp $(MATLAB_ROOT)/rtw/c/src/ext_mode/common/rtiostream_interface.c $(MATLAB_ROOT)/SupportPackages/toolbox/target/shared/externalmode_daemon/src/ext_svr_daemon.c $(MATLAB_ROOT)/SupportPackages/toolbox/target/supportpackages/arduinotarget/registry/../src/rtiostream_serial_daemon.cpp $(MATLAB_ROOT)/SupportPackages/toolbox/target/shared/externalmode_daemon/src/daemon_checksum.c
...
OBJS = Wire.o twi.o I2Cdev.o MPU6050.o MPU6050wrapper.o LabB_TuneTheGyro.o LabB_TuneTheGyro_data.o updown.o ext_work.o rtiostream_utils.o MW_ArduinoHWInit.o io_wrappers.o arduinoAVRScheduler.o rtiostream_interface.o ext_svr_daemon.o rtiostream_serial_daemon.o daemon_checksum.o
...
%.o : E:/MATLAB-Projects/R7003E/LabB/RensselaerArduinoSupportPackageLibrary/RASPlib/src/%.c
	$(CC) $(CFLAGS) -o "$@" "$<"


%.S.o : E:/MATLAB-Projects/R7003E/LabB/RensselaerArduinoSupportPackageLibrary/RASPlib/src/%.s
	$(AS) $(ASFLAGS) -o "$@" "$<"
...
%.o : E:/MATLAB-Projects/R7003E/LabB/RensselaerArduinoSupportPackageLibrary/RASPlib/src/%.cpp
	$(CPP) $(CPPFLAGS) -o "$@" "$<"
...
ext_svr_daemon.o : $(MATLAB_ROOT)/SupportPackages/toolbox/target/shared/externalmode_daemon/src/ext_svr_daemon.c
	$(CC) $(CFLAGS) -o "$@" "$<"


rtiostream_serial_daemon.o : $(MATLAB_ROOT)/SupportPackages/toolbox/target/supportpackages/arduinotarget/registry/../src/rtiostream_serial_daemon.cpp
	$(CPP) $(CPPFLAGS) -o "$@" "$<"


daemon_checksum.o : $(MATLAB_ROOT)/SupportPackages/toolbox/target/shared/externalmode_daemon/src/daemon_checksum.c
	$(CC) $(CFLAGS) -o "$@" "$<"
