...
## Generated on : Tue Dec 14 14:35:46 2021
...
INCLUDES_BUILDINFO = -I$(START_DIR) -I$(MATLAB_ROOT)/SupportPackages/toolbox/target/supportpackages/arduinobase/include -IE:/MATLAB-Projects/R7003E/LabB/RensselaerArduinoSupportPackageLibrary/RASPlib/src -IE:/MATLAB-Projects/R7003E/LabB/RensselaerArduinoSupportPackageLibrary/RASPlib/include -I$(MATLAB_ROOT)/SupportPackages/3P.instrset/arduinoide.instrset/hardware/arduino/avr/libraries/Wire -I$(MATLAB_ROOT)/SupportPackages/3P.instrset/arduinoide.instrset/hardware/arduino/avr/libraries/Wire/utility -I$(MATLAB_ROOT)/SupportPackages/3P.instrset/arduinoide.instrset/hardware/arduino/avr/libraries/Wire/src -I$(MATLAB_ROOT)/SupportPackages/3P.instrset/arduinoide.instrset/hardware/arduino/avr/libraries/Wire/src/utility -I$(MATLAB_ROOT)/SupportPackages/toolbox/target/shared/svd/include -I$(START_DIR)/LabC_CompensatorOverRobot_ert_rtw -I$(MATLAB_ROOT)/extern/include -I$(MATLAB_ROOT)/simulink/include -I$(MATLAB_ROOT)/rtw/c/src -I$(MATLAB_ROOT)/rtw/c/src/ext_mode/common -I$(MATLAB_ROOT)/rtw/c/ert -I$(ARDUINO_ROOT)/hardware/arduino/avr/cores/arduino -I$(ARDUINO_ROOT)/hardware/arduino/avr/variants/mega -I$(MATLAB_ROOT)/SupportPackages/toolbox/target/supportpackages/arduinotarget/include -I$(MATLAB_ROOT)/SupportPackages/toolbox/target/supportpackages/arduinotarget/scheduler/include -I$(ARDUINO_ROOT)/hardware/tools/avr/avr/include/avr -I$(MATLAB_ROOT)/SupportPackages/toolbox/target/shared/externalmode_daemon/include
...
DEFINES_ = -D__MW_TARGET_USE_HARDWARE_RESOURCES_H__ -DMW_TIMERID=5 -DMW_PRESCALAR=256 -DMW_TIMERCOUNT=64661 -DMW_SCHEDULERCOUNTER=1 -D_RTT_BAUDRATE_SERIAL0_=115200 -D_RTT_BAUDRATE_SERIAL1_=9600 -D_RTT_BAUDRATE_SERIAL2_=9600 -D_RTT_BAUDRATE_SERIAL3_=9600 -D_RTT_ANALOG_REF_=0 -D_RTT_OVERRUN_DIGITAL_PIN_=13
...
encoder_arduino.o : E:/MATLAB-Projects/R7003E/LabB/RensselaerArduinoSupportPackageLibrary/RASPlib/blocks/../src/encoder_arduino.cpp
	$(CPP) $(CPPFLAGS) -o "$@" "$<"
