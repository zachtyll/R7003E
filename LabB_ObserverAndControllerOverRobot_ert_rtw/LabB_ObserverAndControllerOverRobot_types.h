...
/* Custom Type definition for MATLABSystem: '<S53>/PWM' */
#include "MW_SVD.h"
...
typedef struct tag_Autt3LIKmDdtX0LpW6qYZF Encoder_arduino_LabB_ObserverAn;
...
typedef struct tag_kwccTvFMMbYBwUySNkudLG soMPU6050Gyro_LabB_ObserverAndC;
...
#ifndef typedef_cell_wrap_LabB_ObserverAndContr
#define typedef_cell_wrap_LabB_ObserverAndContr

typedef struct tag_PMfBDzoakfdM9QAdfx2o6D cell_wrap_LabB_ObserverAndContr;

#endif                               /*typedef_cell_wrap_LabB_ObserverAndContr*/
...
struct tag_uKrQkorC4YuW9dPwXssOBF
{
  ...
  int32_T isInitialized;
  boolean_T isSetupComplete;
  cell_wrap_LabB_ObserverAndContr inputVarSize;
  real_T Protocol;
  real_T port;
...
typedef struct tag_uKrQkorC4YuW9dPwXssOBF codertarget_arduinobase_inter_a;
