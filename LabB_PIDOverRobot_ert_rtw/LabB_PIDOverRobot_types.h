...
typedef struct tag_Autt3LIKmDdtX0LpW6qYZF Encoder_arduino_LabB_PIDOverRob;
...
typedef struct tag_kwccTvFMMbYBwUySNkudLG soMPU6050Gyro_LabB_PIDOverRobot;
...
#ifndef typedef_cell_wrap_LabB_PIDOverRobot
#define typedef_cell_wrap_LabB_PIDOverRobot

typedef struct tag_PMfBDzoakfdM9QAdfx2o6D cell_wrap_LabB_PIDOverRobot;

#endif                                 /*typedef_cell_wrap_LabB_PIDOverRobot*/
...
struct tag_uKrQkorC4YuW9dPwXssOBF
{
  ...
  int32_T isInitialized;
  boolean_T isSetupComplete;
  cell_wrap_LabB_PIDOverRobot inputVarSize;
  real_T Protocol;
  real_T port;
...
typedef struct tag_uKrQkorC4YuW9dPwXssOBF codertarget_arduinobase_inter_n;
